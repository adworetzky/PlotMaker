...
public void drawLines(PGraphics element_, float layer1Tolerance_, float layer2Tolerance_, float layer3Tolerance_, float noiseScalar_) {
    fi.blendMode(BLEND);
    element_.noFill();
    element_.push();
    ...
    for (int y = margin; y < element_.height - margin; y += lineSpacing) {
        ...
        for (int x = margin; x < element_.width - margin; x += lineSpacing) {
            ...
            int c2 = tb.get(PApplet.parseInt(x + noiseVar), PApplet.parseInt(y + noiseVar));
            float bri = brightness(c2);
            if (b < layer2Tolerance_ * 1.25f && bri > 0 && x + noiseVar < element_.width - margin && x + noiseVar > margin && y + noiseVar < element_.height - margin && y + noiseVar > margin) {
    ...
    for (int y = margin; y < element_.height - margin; y += lineSpacing) {
        ...
        for (int x = margin; x < element_.width - margin; x += lineSpacing) {
            ...
            int c2 = tb.get(PApplet.parseInt(x + noiseVar), PApplet.parseInt(y + noiseVar));
            float bri = brightness(c2);
            if (g < layer3Tolerance_ * 1.5f && bri > 0 && x + noiseVar < element_.width - margin && x + noiseVar > margin && y + noiseVar < element_.height - margin && y + noiseVar > margin) {
